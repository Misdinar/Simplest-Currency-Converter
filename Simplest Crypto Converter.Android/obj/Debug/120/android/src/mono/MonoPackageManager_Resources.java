...
public class MonoPackageManager_Resources {
	public static String[] Assemblies = new String[]{
		/* We need to ensure that "Simplest Crypto Converter.Android.dll" comes first in this list. */
		"Simplest Crypto Converter.Android.dll",
		"FormsViewGroup.dll",
		"Simplest Crypto Converter.dll",
